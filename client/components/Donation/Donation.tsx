...
import { fetchAllCampaigns, fetchCampaignById } from '../../logics/gift'
  ...
  return (
    <div className="dashboard-container h-screen ">
      ...
      {campaign.title !== undefined ? <div className='flex flex-1 m-10 justify-center float-center items-center'>
        <Details donorAccount={account} address={address} id={campaignId} showDonate={true} className='p-10 rounded-xl shadow-md' externalLink={campaign.externalLink} name={campaign.title} collectedAmount={campaign.collectedAmount} targetAmount={campaign.targetAmount} description={campaign.description}
