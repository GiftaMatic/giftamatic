...
const FeaturedCampaigns = () => {
  return <div className='flex overflow-hidden lg:mt-10 lg:ml-10 rounded-tl-[120px] lg:rounded-bl-[120px] bg-gradient-to-b from-purple-500 to-pink-400 h-full flex-col items-center lg:min-h-[80vh] lg:flex-row justify-center lg:justify-start'>
